...
export default async function AdminRaffle27May2026Page() {
  ...
  return (
    <DashboardShell navItems={controlNavItems} subtitle="Operacion y ventas de la landing especial" title="Rifa 2026">
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={1.5} useFlexGap flexWrap="wrap">
        ...
        <Button component={Link} href="/rifa2026" target="_blank" variant="contained">
